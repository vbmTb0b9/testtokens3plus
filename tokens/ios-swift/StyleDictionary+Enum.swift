...
public enum StyleDictionaryEnum {
    ...
    public static let colorCtaBackground = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1)
    public static let colorGray = UIColor(red: 0.545, green: 0.545, blue: 0.545, alpha: 1)
    public static let colorPink31 = UIColor(red: 1.000, green: 0.000, blue: 0.910, alpha: 1)
    public static let colorPurple = UIColor(red: 0.400, green: 0.000, blue: 0.561, alpha: 1)
